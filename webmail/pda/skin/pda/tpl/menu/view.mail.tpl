<table  width="100%">
	<tr>
		<td>
			<input type="submit" name="_a[go_to_main_page]" class="button" value="{lang::pda::home}" onclick="changeFormTarget(event);" />
		</td>
		<th width="100%"></th>
		<td>
			...
			<input type="hidden" name="_a[logout][action]" value="logout"/></td>
	</tr>
</table>