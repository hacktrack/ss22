...
<head>
	...
	<!-- CSS -->
	{optional stylesheet}
	<link rel="stylesheet" type="text/css" href="../basic/minimizer/index.php?style={dynamic stylesheet}{!optional *::media}{.*::src}{/optional},{/dynamic}none" />
	{dynamic stylesheet}{optional *::media}
	<link rel="stylesheet" type="text/css" media="{.*::media}" href="minimizer/index.php?style={.*::src}" />
	{/optional}{/dynamic}
	{/optional}
</head>
<body{optional high_contrast} class="contrast"{/optional}>
