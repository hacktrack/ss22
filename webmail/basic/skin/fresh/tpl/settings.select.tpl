...
<input type="hidden" name="{property::old_name}" value="{dynamic property::options}{optional *::selected}{.*::value}{/optional}{/dynamic}" {dynamic property::events} {.*::name}="{.*::value}"{/dynamic}/>
