...
<head>
 ...
 <script type="text/javascript" src="{base ''}scripts/meeting/meeting.js"></script>
 <script type="text/javascript" src="{base ''}scripts/meeting/meeting.core.js"></script>
 <script type="text/javascript" src="{base ''}scripts/meeting/meeting.console.js"></script>
 <script type="text/javascript" src="{base ''}scripts/meeting/meeting.status.js"></script>
 <script type="text/javascript" src="{base ''}scripts/meeting/meeting.mikogo.js"></script>
 <script type="text/javascript" src="{base ''}scripts/meeting/meeting.sip.js"></script>
 <script type="text/javascript" src="{base ''}scripts/meeting/meeting.chat.js"></script>
...
<body id="bodyTag" class="blue" meetingID="{meetingID}">

{!optional meeting_supported}
<form method="post" action="?{htmlspecialchars query_string}&amp;siponly">
	<br />
	<div id="divBox">
		<p class="info">
			{lang::login_screen::desktop_sharing_mobile_warning}<br />
		</p>
		<p class="info" style="text-align:center; padding-top:0;">
			<a href="http://www.mikogo.com/download/mobile-download/" target="_blank">{lang::login_screen::desktop_sharing_app}</a><br />
			<br />
			<span class="small">{lang::login_screen::conference_phone_number}</span><br />
			<span class="big" id="meetingNumber">-</span>
			<br />
			<br />
			<span class="small">{lang::login_screen::desktop_sharing_id}</span><br />
			<span class="big" id="mikogoID">-</span>
		</p>
	</div>
</form>
{/optional}
		...
		<!-- -->
					...
					<div id="loginWindow">
						...
						<table cellspacing="0" cellpadding="0" class="wsto">
							<tr>
								...
								<td class="aright other" id="memberTd"><a href="?meeting={meetingID}&member">{lang::login_screen::already_a_member}</a></td>
							</tr>
						</table>
					</div>
				</div>
			...
			<div id="meetingErrorInfo">
				...
				<table>
					...
					<tr>
						<td>
							<span class="small"><strong>{lang::login_screen::desktop_sharing_id}:</strong></span>
						</td>
						<td>
							<span class="big mikogoID">-</span>
						</td>
					</tr>
				</table>
			</div>
...
{/optional}
	...
	<div class="hiddenBox"><div id="mikogo"></div><div id="sip"></div></div>
