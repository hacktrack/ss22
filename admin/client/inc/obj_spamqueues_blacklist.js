_me = obj_spamqueues_blacklist.prototype;
function obj_spamqueues_blacklist(){};
...
_me._load = function()
{
	...
	this.list._init('obj_spamqueues_blackwhitelist',false,function(linesPerPage,page,callback){
		...
		com.spamqueues.getBlacklist(mask,sender,owner,domain,linesPerPage,page,[function(aData){
...
_me._addItem=function(){
	...
	popup.main.btn_save._onclick=function(){
		...
		com.spamqueues.addBlacklist(popup.main.input_sender._value(),popup.main.input_owner._value(),function(success){
