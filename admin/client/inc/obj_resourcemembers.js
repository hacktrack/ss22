function obj_resourcemembers(){};
var _me = obj_resourcemembers.prototype;
/**
 * @brief:
 * @date : 01.12.2014
 **/
...
_me._load = function(domain)
{
	...
	me._draw('obj_resourcemembers', '', {items:{}});
	...
	try
	{
		...
		var resources = new Account(location.parsed_query.account);
		var members = this.__members = resources.getMemberList();
...
_me._deleteSelectedMembers=function(){
	...
	log.info(['resourcemembers-delete',list]);
...
_me._addMembers=function(){
	...
	gui.accountpicker(function(items,type){
		...
		log.log(['resourcemembers-addmembers',old,list,new_items]);
